...
package net.floodlightcontroller.qosoverlldp;
...
public interface IQoSoverLLDPService extends IFloodlightService {
	...
	public boolean setDeviceHistoryQoSListDispalySize(int dispalysize);
