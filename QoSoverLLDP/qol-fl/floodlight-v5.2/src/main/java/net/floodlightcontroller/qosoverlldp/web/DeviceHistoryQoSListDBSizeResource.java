...
public class DeviceHistoryQoSListDBSizeResource extends ServerResource {
    ...
    public String retrieve() {
        ...
        int size = Integer.parseInt((String) getRequestAttributes().get("device-history-qos-list-db-size"));
        if(qosoverlldp.setDeviceHistoryQoSListDBSize(size)){
            return "Successful devicehistoryqosdbsize is set to "+size;
        }else{
            return "Error:devicehistoryqosdbsize must be more than dispalysize:"+displaysize;
        }
    }
