...
public class DeviceQoSMapListforWebGUIResource extends ServerResource {
    ...
    public Object retrieve(){
        ...
        ArrayList<HashMap<String,String>> deviceqosmaplist = new ArrayList<>();
        for(String device:deviceCurrentQoSDB.keySet()){
            deviceqosmaplist.add(new HashMap<String,String>(){{
                put("device",device);
                put("time",deviceCurrentQoSDB.get(device).getVisualTime());
                put("bandwidth",deviceCurrentQoSDB.get(device).getvisualBandwidth());
                put("delay",deviceCurrentQoSDB.get(device).getvisualDelay());
                put("jitter",deviceCurrentQoSDB.get(device).getvisualJitter());
                put("loss",deviceCurrentQoSDB.get(device).getLoss());
                put("latency",deviceCurrentQoSDB.get(device).getvisualLatency());
            }});
        }
        return deviceqosmaplist;
    }
