...
import static net.floodlightcontroller.qosoverlldp.internal.QoSoverLLDPManager.Max_Device_Num;
    ...
    public Iterator<? extends IDevice> getDevices() {
        ...
        return new FilterIterator<Device>(diter) {
            ...
            protected boolean matches(Device value) {
                if(Long.valueOf(value.getMACAddressString().replaceAll(":",""),16)<=Max_Device_Num){
