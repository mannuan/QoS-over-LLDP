...
public class GetSwitchidPortidListMapforWebGUIResource extends ServerResource {
    ...
    public Object retrieve(){
        ...
        HashMap<Long,HashSet<Long>> swicthidportidlistmap = new HashMap<Long,HashSet<Long>>();
        for(DeviceCurrentQoS qos:deviceCurrentQoSDB.values()){
            if(!swicthidportidlistmap.containsKey(qos.getDigitalSwicthID())){
                swicthidportidlistmap.put(qos.getDigitalSwicthID(),new HashSet<Long>(){{
                    add(qos.getPortid());
                }});
            }
            swicthidportidlistmap.put(qos.getDigitalSwicthID(),swicthidportidlistmap.get(qos.getDigitalSwicthID())).add(qos.getPortid());
        }
        return swicthidportidlistmap;
    }
}
