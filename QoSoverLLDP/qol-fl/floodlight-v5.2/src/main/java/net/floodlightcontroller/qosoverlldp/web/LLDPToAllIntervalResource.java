...
public class LLDPToAllIntervalResource extends ServerResource {

    @Get("json")
    public String retrieve() {
        String interval = (String) getRequestAttributes().get("lldp-to-all-interval");
        try{
            LinkDiscoveryManager.LLDP_TO_ALL_INTERVAL = Integer.parseInt(interval);
            return "Successful LLDP_TO_ALL_INTERVAL is set to "+interval;
        }catch(Exception e){
            return "Error:LLDP_TO_ALL_INTERVAL must be integer";
        }
    }
