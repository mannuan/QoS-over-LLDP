...
public class QueryQoSforAndroidResource extends ServerResource {
	...
	public List<Map<String,String>> retrieve(){
        ...
        for(String name:qosdatabase.keySet()){
        	Map<String,String> map = new HashMap<>();
        	if(name.equals(device)){
        		map.put("title", name);
        		String bandwidth = qosdatabase.get(name).getvisualBandwidth();
        		String delay = qosdatabase.get(name).getvisualDelay();
        		String jitter = qosdatabase.get(name).getvisualJitter();
        		String loss = qosdatabase.get(name).getLoss();
				String latency = qosdatabase.get(name).getvisualLatency();
        		map.put("detail", bandwidth+"/" + delay + "/" + jitter + "/" + loss + "/" + latency);
        		list.add(map);
        	}
        }
        return list;
